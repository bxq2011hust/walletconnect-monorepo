...
export const RELAYER_DEFAULT_RELAY_URL = "wss://wcrelay.wbchain.com";
export const RELAYER_FAILOVER_RELAY_URL = "wss://wcrelay.wbchain.com.cn";
...
export const RELAYER_SDK_VERSION = "2.13.2";
